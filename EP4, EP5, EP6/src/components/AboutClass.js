    ...
    return (
      <div className='help-container'>
        ...
        <p className='help-intro'>
          Welcome to the Help & Support page! We're here to ensure your
          experience is smooth and hassle-free. Browse through the sections
          below to find answers to common questions or reach out to us directly
          for support.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              ...
              enter your registered email or phone number along with the
              password.
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            <p>
              Use the search bar at the top of the homepage to find your
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              ...
              payments. It may take 5–7 business days for the amount to reflect
              in your account.
            </p>
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            <p>
              Once your order is placed, click on the "Track Order" button in
              the app to see real-time updates.
            </p>
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              Unfortunately, orders cannot be modified once placed. You can
              cancel the order (if allowed) and place a new one.
            </p>
          </li>
        </ul>
        ...
        <p>
          ...
          under the "Feedback" section in the app.
        </p>
      </div>
    )
  }
